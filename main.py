...
if __name__ == "__main__":
    ...
    # Pretty label map (tuple key -> human string from CSV)
    # Keys match what apply_patterns_to_entities returns: (tuple(symbols), tuple(relations))
    rep_to_str = {(tuple(t.symbols), tuple(t.relations)): s for t, s in zip(patterns_tirps, patterns_df["tirp_str"])}
